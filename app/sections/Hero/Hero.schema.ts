    ...
    fields: [
        {
            ...
            component: 'toggle',
            description:
                'Makes entire slide clickable using the first link below',
            toggleLabels: {
                true: 'On',
                false: 'Off',
            },
            ...
            },
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        component: 'group',
                        description:
                            'Static height, aspect ratio, min and max height',
                        fields: [
                            {
                                label: 'Height Type',
                                name: 'heightType',
                            ...
                            },
                            {
                                ...
                                component: 'select',
                                description:
                                    'If enabled, hero set to static height',
                                options: [
                            ...
                            },
                            {
                                ...
                                component: 'select',
                                description:
                                    'Min height on desktop regardless of aspect ratio',
                                options: [
                                    {label: 'None', value: ''},
                                    {
                                        label: '100px',
                                        value: 'md:min-h-[100px]',
                                    },
                                    {
                                        label: '200px',
                                        value: 'md:min-h-[12.5rem]',
                                    },
                                    {
                                        label: '300px',
                                        value: 'md:min-h-[18.75rem]',
                                    },
                                    {label: '400px', value: 'md:min-h-[25rem]'},
                                    {
                                        label: '500px',
                                        value: 'md:min-h-[31.25rem]',
                                    },
                                    {
                                        label: '600px',
                                        value: 'md:min-h-[37.5rem]',
                                    },
                                    {
                                        label: '700px',
                                        value: 'md:min-h-[43.75rem]',
                                    },
                            ...
                            },
                            {
                                ...
                                component: 'select',
                                description:
                                    'Max height aspect ratio can grow to on desktop',
                                options: [
                                    {label: 'None', value: ''},
                                    {
                                        label: '200px',
                                        value: 'md:max-h-[12.5rem]',
                                    },
                                    {
                                        label: '300px',
                                        value: 'md:max-h-[18.75rem]',
                                    },
                                    {label: '400px', value: 'md:max-h-[25rem]'},
                                    {
                                        label: '500px',
                                        value: 'md:max-h-[31.25rem]',
                                    },
                                    {
                                        label: '600px',
                                        value: 'md:max-h-[37.5rem]',
                                    },
                                    {
                                        label: '700px',
                                        value: 'md:max-h-[43.75rem]',
                                    },
                        ...
                        fields: [
                            ...
                            },
                            {
                                ...
                                options: [
                                    {
                                        label: '200px',
                                        value: 'max-md:h-[12.5rem]',
                                    },
                                    {
                                        label: '300px',
                                        value: 'max-md:h-[18.75rem]',
                                    },
                                    {label: '400px', value: 'max-md:h-[25rem]'},
                                    {
                                        label: '500px',
                                        value: 'max-md:h-[31.25rem]',
                                    },
                                    {
                                        label: '600px',
                                        value: 'max-md:h-[37.5rem]',
                                    },
                                    {
                                        label: '700px',
                                        value: 'max-md:h-[43.75rem]',
                                    },
                            ...
                            },
                            {
                                ...
                                options: [
                                    ...
                                    {
                                        label: '3:1',
                                        value: 'max-md:aspect-[3/1]',
                                    },
                                    {
                                        label: '5:2',
                                        value: 'max-md:aspect-[5/2]',
                                    },
                                    {
                                        label: '2:1',
                                        value: 'max-md:aspect-[2/1]',
                                    },
                                    {
                                        label: '16:9',
                                        value: 'max-md:aspect-[16/9]',
                                    },
                                    {
                                        label: '3:2',
                                        value: 'max-md:aspect-[3/2]',
                                    },
                                    {
                                        label: '4:3',
                                        value: 'max-md:aspect-[4/3]',
                                    },
                                    {
                                        label: '5:4',
                                        value: 'max-md:aspect-[5/4]',
                                    },
                                    {
                                        label: '1:1',
                                        value: 'max-md:aspect-[1/1]',
                                    },
                                    {
                                        label: '4:5',
                                        value: 'max-md:aspect-[4/5]',
                                    },
                                    {
                                        label: '3:4',
                                        value: 'max-md:aspect-[3/4]',
                                    },
                                    {
                                        label: '2:3',
                                        value: 'max-md:aspect-[2/3]',
                                    },
                                    {
                                        label: '9:16',
                                        value: 'max-md:aspect-[9/16]',
                                    },
                                ],
                            },
                            {
                                ...
                                component: 'select',
                                description:
                                    'Min height on mobile regardless of aspect ratio',
                                options: [
                                    {label: 'None', value: ''},
                                    {
                                        label: '100px',
                                    ...
                                    {
                                        label: '200px',
                                        value: 'max-md:min-h-[12.5rem]',
                                    },
                                    {
                                        label: '300px',
                                        value: 'max-md:min-h-[18.75rem]',
                                    },
                                    {
                                        label: '400px',
                                        value: 'max-md:min-h-[25rem]',
                                    },
                                    {
                                        label: '500px',
                                        value: 'max-md:min-h-[31.25rem]',
                                    },
                                    {
                                        label: '600px',
                                        value: 'max-md:min-h-[37.5rem]',
                                    },
                                    {
                                        label: '700px',
                                        value: 'max-md:min-h-[43.75rem]',
                                    },
                                    {
                                        label: '800px',
                                        value: 'max-md:min-h-[50rem]',
                                    },
                                ],
                            },
                            {
                                ...
                                component: 'select',
                                description:
                                    'Max height aspect ratio can grow to on mobile',
                                options: [
                                    {label: 'None', value: ''},
                                    {
                                        label: '200px',
                                        value: 'max-md:max-h-[12.5rem]',
                                    },
                                    {
                                        label: '300px',
                                        value: 'max-md:max-h-[18.75rem]',
                                    },
                                    {
                                        label: '400px',
                                        value: 'max-md:max-h-[25rem]',
                                    },
                                    {
                                        label: '500px',
                                        value: 'max-md:max-h-[31.25rem]',
                                    },
                                    {
                                        label: '600px',
                                        value: 'max-md:max-h-[37.5rem]',
                                    },
                                    {
                                        label: '700px',
                                        value: 'max-md:max-h-[43.75rem]',
                                    },
                                    {
                                        label: '800px',
                                        value: 'max-md:max-h-[50rem]',
                                    },
                                ],
                            },
                        ],
