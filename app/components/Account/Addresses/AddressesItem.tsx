...
export function AddressesItem({
  ...
  return (
    <div
      className={`relative flex h-full flex-col justify-between gap-x-4 gap-y-6 rounded border border-border p-6 xs:flex-row md:flex-col lg:flex-row`}
    >
      <div>
      ...
      <div
        className={`flex justify-between gap-6 xs:flex-col md:flex-row lg:flex-col`}
      >
      ...
      {isDeleteConfirm && (
        <div
          className={`absolute left-0 top-0 flex size-full flex-col items-center justify-center gap-4 bg-[rgba(255,255,255,0.9)] p-4`}
        >
