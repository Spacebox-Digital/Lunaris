...
export function FooterMenu({settings}: {settings: Settings['footer']}) {
  ...
  return (
    <>
      {/* mobile */}
      <ul
        className={`grid grid-cols-1 text-current md:hidden md:grid-cols-3 lg:grid-cols-4`}
      >
      ...
      {/* desktop */}
      <ul
        className={`hidden grid-cols-1 gap-x-6 gap-y-8 text-current md:grid md:grid-cols-3 lg:grid-cols-4`}
      >
