...
export function Footer() {
  ...
  return (
    ...
    >
      <div
        className={`mx-auto grid max-w-[var(--content-max-width)] grid-cols-1 md:grid-cols-[1fr_300px] md:gap-x-5 md:gap-y-10 xl:grid-cols-[200px_1fr_300px]`}
      >
        <div
          className={`order-1 col-span-1 w-full md:col-span-2 xl:col-span-1`}
        >
          <div
            className={`flex gap-6 border-b border-b-gray px-4 pb-8 md:border-none md:p-0 xl:flex-col`}
          >
        ...
        <div
          className={`max-md:px-contained order-4 col-span-1 flex w-full flex-col gap-4 max-md:pt-8 md:col-span-2 md:gap-6 xl:col-span-3`}
        >
