    ...
    return (
        <div className={`  w-full`}>
            ...
            >
                <div>
                    {superheading && (
                        <p className={`text-superheading mb-1 lg:mb-1.5`}>
                            {superheading}
                        </p>
                    )}
                ...
                {subtext && (
                    <div
                        className={`[&_a]:underline [&_h1]:text-base [&_h2]:text-base [&_h3]:text-base [&_h4]:text-base [&_h5]:text-base [&_h6]:text-base [&_p]:text-base`}
                    >
                ...
                {buttons?.length > 0 && (
                    <ul
                        className={`flex flex-col justify-center gap-4 xs:flex-row`}
                    >
