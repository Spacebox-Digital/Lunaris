...
export function CustomerAccountLayout({children}: {children: React.ReactNode}) {
    ...
    return (
        <section className={` `} data-comp={CustomerAccountLayout.displayName}>
            <div
                ...
                <div>
                    ...
                    >
                        <div className={`flex-1`}>
                            <h2
                                className={`text-h4 md:text-h5 lg:text-h4 mb-1 break-words`}
                            >
                                Hi
                                {customer?.firstName
                                    ? `, ${customer.firstName}`
                    ...
                    >
                        <ul
                            className={`flex flex-col items-start md:gap-4 lg:gap-6`}
                        >
