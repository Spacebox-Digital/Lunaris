...
export function ProductsSlider({
    ...
    const isLoop =
        isFullBleedAndCentered || sliderStyle === 'containedWithLoop';
    const maxWidthClass =
    ...
    return (
        <div className={` ${!isFullBleedAndCentered ? 'lg:' : ''}`}>
            <div className={`m-auto flex flex-col items-center`}>
                ...
                {products?.length > 0 && (
                    <Swiper
                        ...
                        grabCursor
                        loop={
                            isLoop && products.length >= slidesPerViewMobile * 2
                        }
                        modules={[Navigation]}
                        navigation={{
                        ...
                        breakpoints={{
                            768: {
                                ...
                                spaceBetween: 20,
                                slidesOffsetBefore: isFullBleedAndCentered
                                    ? 0
                                    : 32,
                                slidesOffsetAfter: isFullBleedAndCentered
                                    ? 0
                                    : 32,
                            },
                            1024: {
